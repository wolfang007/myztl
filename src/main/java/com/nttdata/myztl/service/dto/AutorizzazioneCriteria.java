...
/**
 * Criteria class for the {@link com.nttdata.myztl.domain.Autorizzazione} entity. This class is used
 * in {@link com.nttdata.myztl.web.rest.AutorizzazioneResource} to receive all the possible filtering options from
...
public class AutorizzazioneCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, nome, stato, permessoTemporaneoId);
    }
