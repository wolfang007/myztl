...
import com.nttdata.myztl.ZtlApp;
...
import com.nttdata.myztl.domain.PermessoTemporaneo;
import com.nttdata.myztl.domain.TipologiaPermesso;
import com.nttdata.myztl.domain.Zona;
import com.nttdata.myztl.domain.enumeration.TipoPersona;
import com.nttdata.myztl.repository.PermessoTemporaneoRepository;
import com.nttdata.myztl.service.PermessoTemporaneoQueryService;
import com.nttdata.myztl.service.PermessoTemporaneoService;
import com.nttdata.myztl.service.dto.PermessoTemporaneoCriteria;
 ...
 */
@SpringBootTest(classes = ZtlApp.class)
...
public class PermessoTemporaneoResourceIT {
    ...
    private static final Boolean DEFAULT_TARGA_ESTERA = false;
    private static final Boolean UPDATED_TARGA_ESTERA = true;
    ...
    public static PermessoTemporaneo createEntity(EntityManager em) {
        PermessoTemporaneo permessoTemporaneo = new PermessoTemporaneo()
            .targa(DEFAULT_TARGA)
            .targaEstera(DEFAULT_TARGA_ESTERA)
    ...
    public static PermessoTemporaneo createUpdatedEntity(EntityManager em) {
        PermessoTemporaneo permessoTemporaneo = new PermessoTemporaneo()
            .targa(UPDATED_TARGA)
            .targaEstera(UPDATED_TARGA_ESTERA)
    ...
    public void createPermessoTemporaneo() throws Exception {
        ...
        assertThat(testPermessoTemporaneo.isTargaEstera()).isEqualTo(DEFAULT_TARGA_ESTERA);
    ...
    public void getAllPermessoTemporaneos() throws Exception {
        ...
        restPermessoTemporaneoMockMvc
            ...
            .andExpect(jsonPath("$.[*].targaEstera").value(hasItem(DEFAULT_TARGA_ESTERA.booleanValue())))
    ...
    public void getPermessoTemporaneo() throws Exception {
        ...
        restPermessoTemporaneoMockMvc
            ...
            .andExpect(jsonPath("$.targaEstera").value(DEFAULT_TARGA_ESTERA.booleanValue()))
    ...
    @Test
    @Transactional
    public void getAllPermessoTemporaneosByTargaEsteraIsEqualToSomething() throws Exception {
        // Initialize the database
        permessoTemporaneoRepository.saveAndFlush(permessoTemporaneo);

        // Get all the permessoTemporaneoList where targaEstera equals to DEFAULT_TARGA_ESTERA
        defaultPermessoTemporaneoShouldBeFound("targaEstera.equals=" + DEFAULT_TARGA_ESTERA);

        // Get all the permessoTemporaneoList where targaEstera equals to UPDATED_TARGA_ESTERA
        defaultPermessoTemporaneoShouldNotBeFound("targaEstera.equals=" + UPDATED_TARGA_ESTERA);
    }

    @Test
    @Transactional
    public void getAllPermessoTemporaneosByTargaEsteraIsNotEqualToSomething() throws Exception {
        // Initialize the database
        permessoTemporaneoRepository.saveAndFlush(permessoTemporaneo);

        // Get all the permessoTemporaneoList where targaEstera not equals to DEFAULT_TARGA_ESTERA
        defaultPermessoTemporaneoShouldNotBeFound("targaEstera.notEquals=" + DEFAULT_TARGA_ESTERA);

        // Get all the permessoTemporaneoList where targaEstera not equals to UPDATED_TARGA_ESTERA
        defaultPermessoTemporaneoShouldBeFound("targaEstera.notEquals=" + UPDATED_TARGA_ESTERA);
    }

    @Test
    @Transactional
    public void getAllPermessoTemporaneosByTargaEsteraIsInShouldWork() throws Exception {
        // Initialize the database
        permessoTemporaneoRepository.saveAndFlush(permessoTemporaneo);

        // Get all the permessoTemporaneoList where targaEstera in DEFAULT_TARGA_ESTERA or UPDATED_TARGA_ESTERA
        defaultPermessoTemporaneoShouldBeFound("targaEstera.in=" + DEFAULT_TARGA_ESTERA + "," + UPDATED_TARGA_ESTERA);

        // Get all the permessoTemporaneoList where targaEstera equals to UPDATED_TARGA_ESTERA
        defaultPermessoTemporaneoShouldNotBeFound("targaEstera.in=" + UPDATED_TARGA_ESTERA);
    }

    @Test
    @Transactional
    public void getAllPermessoTemporaneosByTargaEsteraIsNullOrNotNull() throws Exception {
        // Initialize the database
        permessoTemporaneoRepository.saveAndFlush(permessoTemporaneo);

        // Get all the permessoTemporaneoList where targaEstera is not null
        defaultPermessoTemporaneoShouldBeFound("targaEstera.specified=true");

        // Get all the permessoTemporaneoList where targaEstera is null
        defaultPermessoTemporaneoShouldNotBeFound("targaEstera.specified=false");
    }
    ...
    public void updatePermessoTemporaneo() throws Exception {
        ...
        assertThat(testPermessoTemporaneo.isTargaEstera()).isEqualTo(UPDATED_TARGA_ESTERA);
