...
import { AutorizzazioneComponent } from 'app/entities/autorizzazione/autorizzazione.component';
...
describe('Component Tests', () => {
  describe('Autorizzazione Management Component', () => {
    let comp: AutorizzazioneComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AutorizzazioneComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.autorizzaziones && comp.autorizzaziones[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
