...
import { ZonaComponent } from 'app/entities/zona/zona.component';
import { ZonaService } from 'app/entities/zona/zona.service';
import { Zona } from 'app/shared/model/zona.model';

describe('Component Tests', () => {
  describe('Zona Management Component', () => {
    let comp: ZonaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ZonaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.zonas && comp.zonas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
