...
describe('Varco e2e test', () => {
  ...
  it('should load Varcos', async () => {
    ...
    expect(await varcoComponentsPage.getTitle()).to.eq('ztlApp.varco.home.title');
  ...
  it('should load create Varco page', async () => {
    ...
    expect(await varcoUpdatePage.getPageTitle()).to.eq('ztlApp.varco.home.createOrEditLabel');
  ...
  it('should delete last Varco', async () => {
    ...
    expect(await varcoDeleteDialog.getDialogTitle()).to.eq('ztlApp.varco.delete.question');
