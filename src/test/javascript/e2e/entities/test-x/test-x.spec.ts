...
describe('TestX e2e test', () => {
  ...
  it('should load TestXES', async () => {
    ...
    expect(await testXComponentsPage.getTitle()).to.eq('ztlApp.testX.home.title');
  ...
  it('should load create TestX page', async () => {
    ...
    expect(await testXUpdatePage.getPageTitle()).to.eq('ztlApp.testX.home.createOrEditLabel');
  ...
  it('should delete last TestX', async () => {
    ...
    expect(await testXDeleteDialog.getDialogTitle()).to.eq('ztlApp.testX.delete.question');
