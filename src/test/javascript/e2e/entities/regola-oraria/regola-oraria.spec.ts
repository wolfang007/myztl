...
describe('RegolaOraria e2e test', () => {
  ...
  it('should load RegolaOrarias', async () => {
    ...
    expect(await regolaOrariaComponentsPage.getTitle()).to.eq('ztlApp.regolaOraria.home.title');
    await browser.wait(
  ...
  it('should load create RegolaOraria page', async () => {
    ...
    expect(await regolaOrariaUpdatePage.getPageTitle()).to.eq('ztlApp.regolaOraria.home.createOrEditLabel');
  ...
  it('should delete last RegolaOraria', async () => {
    ...
    expect(await regolaOrariaDeleteDialog.getDialogTitle()).to.eq('ztlApp.regolaOraria.delete.question');
